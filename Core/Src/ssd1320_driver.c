...
uint8_t frame_buffer_data_a[SSD1320_BUF_SIZE];
uint8_t frame_buffer_data_b[SSD1320_BUF_SIZE];
uint8_t frame_buffer_data_c[SSD1320_BUF_SIZE];
uint8_t frame_buffer_data_d[SSD1320_BUF_SIZE];
...
void SSD1320_SetAddress(uint16_t x1,uint16_t x2,uint16_t y1,uint16_t y2)
{
  ...
  SSD1320_SendCommandLeft(0x22); // Row Address Set
  SSD1320_SendCommandLeft(y1);
  SSD1320_SendCommandLeft(y2);

  SSD1320_SendCommandRight(0x21); // Column Address Set
  SSD1320_SendCommandRight(x1);
  SSD1320_SendCommandRight(x2);
  SSD1320_SendCommandRight(0x22); // Row Address Set
