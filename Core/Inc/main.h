...
#define SPI1_FR_EXTI_IRQn EXTI2_IRQn
#define SPI2_FR_Pin GPIO_PIN_3
#define SPI2_FR_GPIO_Port GPIOC
#define SPI2_FR_EXTI_IRQn EXTI3_IRQn
...
#define ROT_ENCOD_LEFT_EXTI_IRQn EXTI9_5_IRQn
#define ROT_ENCOD_RIGHT_Pin GPIO_PIN_9
#define ROT_ENCOD_RIGHT_GPIO_Port GPIOE
#define ROT_ENCOD_RIGHT_EXTI_IRQn EXTI9_5_IRQn
...
#define KEYB_ROW_IN_7_Pin GPIO_PIN_6
#define KEYB_ROW_IN_7_GPIO_Port GPIOC
#define KEYB_ROW_IN_0_Pin GPIO_PIN_7
#define KEYB_ROW_IN_0_GPIO_Port GPIOC
#define KEYB_ROW_IN_6_NOT_WORKING_Pin GPIO_PIN_8
#define KEYB_ROW_IN_6_NOT_WORKING_GPIO_Port GPIOC
#define KEYB_ROW_IN_1_NOTWORKING_Pin GPIO_PIN_9
#define KEYB_ROW_IN_1_NOTWORKING_GPIO_Port GPIOC
...
#define KEYB_ROW_IN_1_Pin GPIO_PIN_12
#define KEYB_ROW_IN_1_GPIO_Port GPIOA
#define KEYB_ROW_IN_6_Pin GPIO_PIN_15
#define KEYB_ROW_IN_6_GPIO_Port GPIOA
